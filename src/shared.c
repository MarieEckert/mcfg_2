...
char *
strchrnul(const char *str, int c)
{
...
char *
strcpy_until(char *src, char delimiter)
{
	size_t offs = 0;
...
char *
bstrcpy_until(char *src, char *src_org, char delimiter)
{
	int offs = 0;
...
char *
find_prev(char *src, char *src_org, char delimiter)
{
	int offs = 0;
	while((src - offs) > src_org) {
		if((src - offs)[0] == delimiter) {
