...
#define cptrlist_init	_SHARED_NAMESPACED_DECL(cptrlist_init)
#define cptrlist_append _SHARED_NAMESPACED_DECL(cptrlist_append)
#define cptrlist_insert_or_append \
	_SHARED_NAMESPACED_DECL(cptrlist_insert_or_append)
#define cptrlist_find	 _SHARED_NAMESPACED_DECL(cptrlist_find)
#define cptrlist_free_at _SHARED_NAMESPACED_DECL(cptrlist_free_at)
#define cptrlist_free	 _SHARED_NAMESPACED_DECL(cptrlist_free)
#define cptrlist_destroy _SHARED_NAMESPACED_DECL(cptrlist_destroy)
 ...
 */
ssize_t cptrlist_find(CPtrList *list,
					  void *search,
